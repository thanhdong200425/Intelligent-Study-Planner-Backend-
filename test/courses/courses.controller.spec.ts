...
describe('CoursesController',  () => {
    ...
    describe('create',  () => {
        it('should create a course', () => {
            ...
            let result =  controller.create(userId, dto)
    ...
    describe('list', () => {
        it('should list all courses', () => {
            const userId = 1;
            const courses = [{id: 1, name: 'Course 1', color: '#FFFFFF'}, {id: 2, name: 'Course 2', color: '#000000'}]
            mockCoursesService.findAll.mockReturnValue(courses)
            let result = controller.list(userId)
    ...
    describe('update', () => {
        it('should update a course', () => {
            ...
            let result = controller.update(userId, id, dto);
